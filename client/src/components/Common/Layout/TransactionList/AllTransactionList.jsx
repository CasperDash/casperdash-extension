					...
					<tbody>
						{transaction.map((transactionListData, i) => (
							<tr key={transactionListData.id}>
								...
								<td
									className={`${transactionListData.transactionValueUpDown} zl_transaction_list_value`}
								>
									{transactionListData.transactionValue}
								</td>
								<td
									className={`${transactionListData.transactionStatusUpDown} zl_transaction_list_status`}
								>
