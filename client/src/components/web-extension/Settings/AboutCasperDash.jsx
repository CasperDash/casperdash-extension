	...
	const SETTINGS = [
		{
			...
			action: () => {
				chrome.tabs.create({ url: getConfig('DOCS_URL') || 'https://docs.casperdash.io' });
			},
		},
		{
			name: 'Support',
			...
			action: () => {
				chrome.tabs.create({ url: getConfig('SUPPORT_URL') || 'https://t.me/CasperDash_Official' });
			},
		},
		{
			name: 'Terms of Use',
			...
			action: () => {
				chrome.tabs.create({ url: getConfig('TERMS_URL') || 'https://casperdash.io/terms-of-use.html' });
			},
		},
		{
			name: 'Privacy Policy',
			...
			action: () => {
				chrome.tabs.create({ url: getConfig('PRIVACY_URL') || 'https://casperdash.io/privacy-policy.html' });
			},
		},
		{
			name: 'About Us',
