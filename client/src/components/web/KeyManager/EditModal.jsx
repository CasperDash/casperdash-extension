...
export const EditModal = ({ field, value, show, handleClose, handleEditValue, handleSummitChange, isDeploying }) => {
	...
	return (
		<Modal show={show} onHide={handleClose} centered className="cd_edit_modal_content">
			...
			<Modal.Footer className="cd_edit_modal_footer">
				<Button variant="primary" onClick={handleSummitChange} disabled={isDeploying}>
					Save
				</Button>
			</Modal.Footer>
		</Modal>
